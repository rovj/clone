        ...
        <div className='Navbar'>
            ...
            <div className='rest'>
                ...
                <div className='enclose'>
                   <i onClick={()=>{document.getElementById("feedLink").click()}} className="fa-solid fa-house icon "></i>
                </div>  
                
                <Link id="profileLink" className="hide" to={`/profile/${id}`}></Link>
                <div className='enclose'>
                  <i onClick={()=>{document.getElementById("profileLink").click()}} className="fa-solid fa-user icon"></i>
                </div>  
                
                <div className='enclose'>
                  <i onClick={() => handleSignOut()} class="fa-solid fa-right-from-bracket icon"></i>
                </div>  
            </div>
        </div>
    )
