...
import "../styles/ChatBox.css"; //imports
...
function ChatBox({ post }) {
  ...
  const postComment = () => {
    ...
    let obj = { // obj context eg: chartObj, userInfoObj
      text: text,
  ...
  return ( // BEM convention
    <div className="comments">
      <div className="top">
        <img src={post.uProfile} className="post-pic" />
        ...
        {loader === true ? (
          ...
          arr.map((comment, index) => (
              <div className="comment" key={index}>
                <img
                  className="img_reel comment-img"
      ...
      <div className="post-area">
        <textarea
          ...
          cols="65"
        />
        <span onClick={postComment} className={`post-button ${opacity}`}>
          Post
        </span>
      </div>
    </div>
